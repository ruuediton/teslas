              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                   ...
                   <input 
                    ...
                    className={`w-full pl-12 pr-4 py-3 bg-gray-50 border-none rounded-xl focus:ring-2 outline-none text-sm font-mono transition-all ${
                      ibanInlineError ? 'ring-2 ring-red-100 bg-red-50/30' : 'focus:ring-primary/20'
                    }`}
                   />
                </div>
